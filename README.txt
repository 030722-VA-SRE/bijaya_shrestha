...
Features:
* abled to use https verbs like get, post and pull for http request and respon.(CRUD operations)
...
* abled to leverage containerized applications using docker and docker-compose.
